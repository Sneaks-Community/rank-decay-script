...
4. Set a cronjob to run daily and voila, you have a nice and automated way of decaying ranks. `wget -q -O /dev/null "https://yourdomain.tld/antisquatter.php?p=anti_squatter_pass"`
